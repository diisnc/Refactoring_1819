...
public class EditarDados extends javax.swing.JFrame {
    ...
    public EditarDados(TradingCore tc, JLabel nome) {
        this.tc = tc;
        this.nome = nome;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField2.setText(tc.getAtualUser().getUsername());
        ...
        jTextField1.setText(tc.getAtualUser().getNome());
        jPasswordField1.setText(new String(tc.getAtualUser().getPassword()));
        jPasswordField2.setText(new String(tc.getAtualUser().getPassword()));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (nome.isEmpty() || password1.length == 0 || password2.length == 0) {
        ...
        tc.editarDados(nome, password1);
        JOptionPane.showMessageDialog(this, "Alterações efetuadas com sucesso", "Atenção",INFORMATION_MESSAGE );
        this.nome.setText("Bem-Vindo "+ nome+" !");
        this.dispose();
